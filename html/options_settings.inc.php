...
<fieldset class="options metabox-holder">
	...
	<div id="formbuilder-admin-left">
		...
		<!--<div class="info-box-formbuilder postbox">
			...
			?></h3>
			<div class="inside">
				<p><?php _e('You can capture the IP address of visitors who fill in forms on your website.  This information can be used for security purposes, or to report harassment problems to the appropriate authorities.', 'formbuilder'); ?></p>
