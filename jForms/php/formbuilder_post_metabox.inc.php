<?php
	...
	function formbuilder_add_custom_box()
	{
		...
		// If we are capable of using meta boxes, use it.
		  if( function_exists( 'add_meta_box' )) {
		    ...
		    add_meta_box( 'formbuilder_sectionid', __( 'Form', 'formbuilder_textdomain' , 'formbuilder'),
	...
	function formbuilder_post_options()
	{
		...
		echo "<div id='formBuilderContactFormOptions'>\n" .
				"<p>" . __("If you wish to display a contact form that you have created using the jForms plugin, please select it from the following dropdown.", 'formbuilder') . "</p>\n" .
				"<select name='formbuilderFormSelection'>\n" .
				"<option value='noform'>" . __("Select form...", 'formbuilder') . "</option>\n";
